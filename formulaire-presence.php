...
<html lang="en">
    ...
    <section class="banner_area">
        ...
        <!--
            ...
            <div class="container">
                <div class="banner_text_inner">
                    <h4>Bonjour les inscriptions sont closes.<br>Nous publierons dans quelques jours la programmation de la journée :).</h4>
                    ...
                    <div class="f_widgets_inner row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <aside class="f_widget contact_widget">
                                ...
                                <div class="f_w_title">  <h3>Nos témoins :</h3></div>
                                <ul>
                                    <li>  <a href="tel:0629402084"> <strong>Foued :</strong> 06 29 40 20 84 </a></li>
                                    <li> <a href="tel:0771107401"> <strong>Olivia :</strong> 07 71 10 74 01 </a></li>
                                </ul>

                                <br/>
                                <div class="f_w_title"> <h3>Nos mails :</h3></div>
                                <ul>
                                    <li><a href="mailto:pierre.louirazin@gmail.com">pierre.louirazin@gmail.com</a></li>
                                    <li><a href="mailto:guerrier.cindy@gmail.com">guerrier.cindy@gmail.com</a></li>
                                </ul>
                            </aside>
                        </div>
                    </div>
