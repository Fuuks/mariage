...
<html lang="en">
    <head>
        ...
        <title>Mariage Cris & Christy</title>
    ...
    <body>
        ...
        <header class="main_menu_area">
            ...
            <a class="navbar-brand font-italic menu_logo"  href="index.html">Cris & Christy<br>28 Mars 2025</a>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check">
                                  ...
                                  <div class="form-group row" id="nb_people">
                                      <label for="example-number-input" class="col-2 col-form-label">Nombre de personnes accompagnants <strong>(même groupe/famille)</strong></label>
                                      <div class="col-10">
                    ...
                    <div class="f_widgets_inner row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <aside class="f_widget contact_widget">
                               ...
                               <a href="mailto:crismilalu@gmail.com">crismilalu@gmail.com</a>
                            </aside>
                        </div>
                    </div>
                </div>
