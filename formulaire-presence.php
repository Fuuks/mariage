    ...
    <body>
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand font-italic" style="color: white;" href="index.html">Mariage Fuki&Béa<br>6 Octobre 2018</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="formulaire.html">Formulaire de présence</a></li>
                        <li class="nav-item"><a  href="informations-pratiques.html">Infos Pratiques</a></li> 
                            ...
                            <aside class="f_widget categories_widget">
                                ...
                                <ul>
                                  <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Accueil</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Programmation de la journée</a></li>
                                   <!-- <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Carte d'invitation</a></li>-->
                                      <li><a href="formulaire.html"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Formulaire de présence</a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Infos Pratiques</a></li>
                           </ul>
                            </aside>
                        </div>
